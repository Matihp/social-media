  ...
  return (
    <Card noPadding={true}>
        <div className="flex justify-between gap-4 py-2 px-5 md:block z-40">
            <h2 className='text-gray-400 hidden mb-3 md:block'>Aca enlaces</h2>
            ...
            <Link className={asPath === `/profile/friends` ? active : nonActive} href={`/profile/${profile}/friends`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
